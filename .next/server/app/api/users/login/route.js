...
if (role !== 'owner' && role !== 'editor') {
  ...
  `).run(f,a,b,c,e,e);let g=j().prepare("SELECT id, name, email, avatar_url, created_at FROM users WHERE id = ?").get(b)||null;return{share_id:f,document_id:a,user_id:b,user_name:g.name,user_email:g.email,user_avatar:g.avatar_url,role:c,created_at:e}}function x(a,b){return j().prepare("DELETE FROM document_shares WHERE document_id = ? AND user_id = ?").run(a,b),!0}},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},19121:a=>{"use strict";a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},29294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},63033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},78335:()=>{},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},96487:()=>{}};var b=require("../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[331,692,711],()=>b(b.s=3659));module.exports=c})();